...
bcftools annotate -r $1 -a /mnt/data/v.nachatoy/genome/common_all_20180418_compressed.vcf.gz --columns ID,CAF,TOPMED --output-type z ${vcfs}${1}.filtered.vcf.gz -o ${vcfs}${1}.filtered.annotated.vcf
